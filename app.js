const stages = [
  {
    ...
    realm: '练气期',
    btc: 0.1,
    breakthrough: '破境箴言 · 先求稳定走下去，再求稳定做出来。',
    summary: '先建立第一阶段的可验证成果。用低风险、可复制、可持续的内容模型，把执行力和稳定输出打磨出来。',
    nodeLabel: '0.1 BTC',
    projects: [
      {
        icon: '📜',
  ...
  },
  {
    ...
    realm: '筑基期',
    btc: 1,
    breakthrough: '破境箴言 · 从单点实践，进化到系统化推进。',
    summary: '站上 1 BTC，重点不再只是“做”，而是形成系统，开始放大内容、节奏与项目闭环。',
    nodeLabel: '1 BTC',
    projects: []
  },
  {
    ...
    realm: '金丹期',
    btc: 5,
    breakthrough: '破境箴言 · 让影响力、积累和机会彼此生长。',
    summary: '到 5 BTC，要求整体路径具备飞轮特性：品牌、资源、内容与合作机会开始互相增强。',
    nodeLabel: '5 BTC',
    projects: []
  },
  {
    ...
    realm: '元婴期',
    btc: 10,
    breakthrough: '破境箴言 · 守住原则，放大复利，掌握节奏。',
    summary: '10 BTC 是长期积累的加速点。此时追求的是更稳的底层资产、更强的影响力，以及更大的机会密度。',
    nodeLabel: '10 BTC',
    projects: []
  }
];
